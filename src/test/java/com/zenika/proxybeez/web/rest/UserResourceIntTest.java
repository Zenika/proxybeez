...
import com.zenika.proxybeez.domain.Authority;
...
import com.zenika.proxybeez.service.mapper.UserMapper;
import com.zenika.proxybeez.web.rest.errors.ExceptionTranslator;
...
public class UserResourceIntTest {
    ...
    private AlibeezUserService alibeezUserService;

    @Before
    public void setup() {
        MockitoAnnotations.initMocks(this);
        UserResource userResource = new UserResource(userRepository, mailService, userService, alibeezUserService);
