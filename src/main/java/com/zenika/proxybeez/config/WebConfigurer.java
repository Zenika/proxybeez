...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    public void customize(ConfigurableEmbeddedServletContainer container) {
        ...
        /*
         * Enable HTTP/2 for Undertow - https://twitter.com/ankinson/status/829256167700492288 HTTP/2 requires HTTPS, so HTTP requests will fallback
         * to HTTP/1.1. See the JHipsterProperties class and your application-*.yml configuration files for more information.
         */
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("AlibeeZ API", "", "1.0", "",
                "dsi@zenika.com", "Zenika", "");
    }
}
